...
function ShowNoPhoneWarning ()
  ...
  exports.pNotify:SendNotification({text = "Ente Belum Punya Handphone, Silahkan Beli dulu!", type = "success", timeout = 1000, layout = "centerRight", queue = "right", animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
end
--[[
function hasPhone (cb)
  if (ESX == nil) then return cb(0) end
